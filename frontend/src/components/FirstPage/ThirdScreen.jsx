...
import ThirdScreenbackgroundImage from '../../images/ThirdSection.jpg'
...
const ThirdScreen = () => {
  ...
  const services = [
    {
      id: 1,
      image: ThirdScreenbackgroundImage,
  ...
  return (
    <Box
    backgroundImage={`url(${ThirdScreenbackgroundImage})`}
      bgSize="cover"
      bgPosition="center"
      w="100%"
      py={20}
    >
      <VStack spacing={8} align="center" textAlign="center" maxW="6xl" mx="auto">
      <Heading
